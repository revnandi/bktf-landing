...
class MouseCanvas extends React.Component {
    ...
    const animatePoints = () => {
      ...
      for (let i = 0; i < points.length; ++i) {
        ...
        if (point.lifetime > duration) {
          ...
          const red = Math.floor(22 - (100 * lifePercent));
          const green = 108;
          const blue = Math.floor(124 + (100 * lifePercent));
  ...
  render = () => {
    ...
    return <canvas ref={this.canvas} width={cWidth} height={cHeight} style={{ zIndex: '0', position: 'fixed' }}/>;
  }
}
